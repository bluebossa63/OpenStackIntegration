	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		builder.setView(inflater.inflate(R.layout.prompt_container_name, null))
				.setPositiveButton(R.string.done,
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int id) {
								EditText editText = (EditText) ContainerNamePromptDialog.this.getDialog().findViewById(R.id.container_name);
								((ContainerListViewActivity)getActivity()).createContainer(editText.getText().toString());
				...
				.setNegativeButton(R.string.cancel,
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int id) {
								ContainerNamePromptDialog.this.getDialog().cancel();
							}
						});
